...
const footer = renderToStaticMarkup(<AppearanceProvider appearance={standardAppearance} theme="light"><SearchBar query="notes" onChange={() => {}} /></AppearanceProvider>)
...
assert.equal(footer.match(/data-surface-material=""/g)?.length, 1)
